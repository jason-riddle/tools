...
import (
	...
	"github.com/jason-riddle/tools/internal/goober/client"
	"github.com/jason-riddle/tools/internal/goober/protocol"
	"github.com/jason-riddle/tools/internal/goober/server"
)

const usage = `goober - a gob message transport tool

Usage:
  goober <command> [flags]
...
func main() {
	...
	default:
		fmt.Fprintf(os.Stderr, "goober: unknown command %q\n\n", os.Args[1])
		fmt.Fprint(os.Stderr, usage)
		os.Exit(1)
	}
}
...
func runServer(args []string) {
	...
	fs.Usage = func() {
		fmt.Fprintln(os.Stderr, "Usage: goober server [flags]")
		fs.PrintDefaults()
	}
...
func runClient(args []string) {
	...
	fs.Usage = func() {
		fmt.Fprintln(os.Stderr, "Usage: goober client [flags]")
		fs.PrintDefaults()
	}
